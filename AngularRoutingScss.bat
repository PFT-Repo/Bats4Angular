...
start cmd.exe /k "cd %UserProfile%\Desktop/test && ng new prueba --skip-install --routing --style scss && cd C:\Users\formacio\Desktop/test/prueba && ng g m components/components && ng g service service/service"
pause
